...
if($_SERVER['REQUEST_METHOD'] == 'POST'){
    ...
    LEFT JOIN tbl_department_computer ON tbl_computer_details.uuid = tbl_department_computer.uuid
    LEFT JOIN tbl_department ON tbl_department_computer.department_id = tbl_department.id 
    WHERE tbl_computer_details.id IN (SELECT Max(tbl_computer_details.id) FROM tbl_computer_details GROUP BY tbl_computer_details.hostname) AND tbl_computer_details.hostname != "" AND tbl_department.id = :department_id GROUP BY tbl_computer_details.hostname ORDER BY hostname ASC;';
